...
test_that("checks correctness of the analysis and print functions", {
  expect_output(print(exampleResults))
  expect_output(print(emptyResults))
  expect_output(print(partialResults))
  expect_output(print.SwissTournament(exampleResults))
  expect_output(print.SwissTournament(emptyResults))
  expect_output(print.SwissTournament(partialResults))
  expect_output(print.SwissTournament(exampleResults, fullReport = TRUE))
  expect_output(print.SwissTournament(emptyResults, fullReport = TRUE))
  expect_output(print.SwissTournament(partialResults, fullReport = TRUE))
  expect_silent(summary.SwissTournament(exampleResults))
  expect_silent(summary.SwissTournament(emptyResults))
  expect_silent(summary.SwissTournament(partialResults))
  ...
  expect_output(print.SwissTournamentSummary(summary(partialResults)))
  expect_output(print.SwissTournamentSummary(summary(exampleResults), fullReport = TRUE))
  expect_output(print.SwissTournamentSummary(summary(emptyResults), fullReport = TRUE))
  expect_output(print.SwissTournamentSummary(summary(partialResults), fullReport = TRUE))
  expect_s3_class(summary(exampleResults), c("SwissTournament", "SwissTournamentSummary"))
  expect_s3_class(summary(emptyResults), c("SwissTournament", "SwissTournamentSummary"))
  expect_s3_class(summary(partialResults), c("SwissTournament", "SwissTournamentSummary"))
